# Contributing to drososhare.net

Thanks for your interest in contributing to the project.

Our first step is to create a community, the FLYslack will be our first communication channel, with a specific channel, #stocks-and-fly-lines : https://app.slack.com/client/TL36G4QLF/CM4TXG4CQ

You may then browse some [issues](https://github.com/open-science-promoters/drososhareweb/issues) and leave a comment if you find something you want to participate in.
